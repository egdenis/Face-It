...
public extension Fadeable {
    ...
    public mutating func fadeOut(duration: NSTimeInterval = 0.1, delay: NSTimeInterval = 0.0, completion: (Bool) -> Void = {(finished: Bool) -> Void in}) {
        UIView.animateWithDuration(duration, delay: delay, options: UIViewAnimationOptions.CurveEaseOut, animations: {
            self.alpha = 0.0
            }, completion: completion)
    }
...
extension UIButton: Fadeable {}
extension UILabel: Fadeable {}
